...
This repository builds and publishes a snap that repackages the `bluez`
...
- The upstream `bluez` package and other archive-sourced components.
...
- https://github.com/canonical/bluez-snap/security/advisories/new
...
`bluez` code), follow Ubuntu's security reporting process:
